...
#ifndef DUMB_NET_DUMB_PROXYING_URL_LOADER_FACTORY_H_
#define DUMB_NET_DUMB_PROXYING_URL_LOADER_FACTORY_H_
...
#endif  // DUMB_NET_DUMB_PROXYING_URL_LOADER_FACTORY_H_
