...
DumbProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    FollowRedirectParams() = default;
DumbProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    ~FollowRedirectParams() = default;

DumbProxyingURLLoaderFactory::InProgressRequest::InProgressRequest(
    DumbProxyingURLLoaderFactory* factory,
    uint64_t request_id,
  ...
  target_client_.set_disconnect_handler(base::BindOnce(
      &DumbProxyingURLLoaderFactory::InProgressRequest::OnRequestError,
...
void DumbProxyingURLLoaderFactory::InProgressRequest::Restart() {
  UpdateRequestInfo();
  RestartInternal();
}

void DumbProxyingURLLoaderFactory::InProgressRequest::UpdateRequestInfo() {
  // TODO(iefremov): Update |ctx_| here and get rid of multiple spots where
  // it is refilled.
}

void DumbProxyingURLLoaderFactory::InProgressRequest::RestartInternal() {
...
void DumbProxyingURLLoaderFactory::InProgressRequest::FollowRedirect(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::SetPriority(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::
...
void DumbProxyingURLLoaderFactory::InProgressRequest::OnReceiveEarlyHints(
    network::mojom::EarlyHintsPtr early_hints) {}

void DumbProxyingURLLoaderFactory::InProgressRequest::OnReceiveResponse(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::OnReceiveRedirect(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::OnUploadProgress(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::OnReceiveCachedMetadata(
    mojo_base::BigBuffer data) {
  target_client_->OnReceiveCachedMetadata(std::move(data));
}

void DumbProxyingURLLoaderFactory::InProgressRequest::OnTransferSizeUpdated(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::OnComplete(
...
void DumbProxyingURLLoaderFactory::InProgressRequest::ContinueToStartRequest(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void DumbProxyingURLLoaderFactory::InProgressRequest::ContinueToSendHeaders(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void DumbProxyingURLLoaderFactory::InProgressRequest::ContinueToBeforeRedirect(
    const net::RedirectInfo& redirect_info,
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
...
void DumbProxyingURLLoaderFactory::InProgressRequest::OnRequestError(
    const network::URLLoaderCompletionStatus& status) {
...
DumbProxyingURLLoaderFactory::DumbProxyingURLLoaderFactory(
    DumbRequestHandler* request_handler,
    content::BrowserContext* browser_context,
    int render_process_id,
    int frame_tree_node_id,
  ...
  target_factory_.set_connection_error_handler(
      base::BindOnce(&DumbProxyingURLLoaderFactory::OnTargetFactoryError,
                     base::Unretained(this)));

  proxy_receivers_.Add(this, std::move(receiver));
  proxy_receivers_.set_disconnect_handler(
      base::BindRepeating(&DumbProxyingURLLoaderFactory::OnProxyBindingError,
                          base::Unretained(this)));
}

DumbProxyingURLLoaderFactory::~DumbProxyingURLLoaderFactory() = default;

// static
bool DumbProxyingURLLoaderFactory::MaybeProxyRequest(
    content::BrowserContext* browser_context,
...
void DumbProxyingURLLoaderFactory::CreateLoaderAndStart(
    mojo::PendingReceiver<network::mojom::URLLoader> loader_receiver,
    int32_t request_id,
    uint32_t options,
    const network::ResourceRequest& request,
...
void DumbProxyingURLLoaderFactory::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver) {
  proxy_receivers_.Add(this, std::move(loader_receiver));
}

void DumbProxyingURLLoaderFactory::OnTargetFactoryError() {
...
void DumbProxyingURLLoaderFactory::OnProxyBindingError() {
...
void DumbProxyingURLLoaderFactory::RemoveRequest(InProgressRequest* request) {
...
void DumbProxyingURLLoaderFactory::MaybeRemoveProxy() {
