...
#ifndef DUMB_COMPONENTS_PRIVACY_DUMB_PRIVACY_GUARD_SERVICE_H_
#define DUMB_COMPONENTS_PRIVACY_DUMB_PRIVACY_GUARD_SERVICE_H_
...
private:
  ...
  DUMB_ALLOW_UNUSED_TYPE PrefService* prefs_;
  std::unique_ptr<PrefChangeRegistrar, content::BrowserThread::DeleteOnUIThread>
      pref_change_registrar_;
};

#endif // DUMB_COMPONENTS_PRIVACY_DUMB_PRIVACY_GUARD_SERVICE_H_
