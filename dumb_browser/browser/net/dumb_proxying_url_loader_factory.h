...
#ifndef DUMB_BROWSER_NET_DUMB_PROXYING_URL_LOADER_FACTORY_H_
#define DUMB_BROWSER_NET_DUMB_PROXYING_URL_LOADER_FACTORY_H_
...
#include "dumb_browser/browser/net/resource_context_data.h"
#include "dumb_browser/browser/net/url_context.h"
...
class DumbProxyingURLLoaderFactory
 ...
 public:
  using DisconnectCallback =
      base::OnceCallback<void(DumbProxyingURLLoaderFactory*)>;
  ...
  class InProgressRequest : public network::mojom::URLLoader,
   ...
   private:
    ...
    DumbProxyingURLLoaderFactory* const factory_;
  ...
  ~DumbProxyingURLLoaderFactory() override;
 ...
 private:
  friend class base::DeleteHelper<DumbProxyingURLLoaderFactory>;
  friend class base::RefCountedDeleteOnSequence<DumbProxyingURLLoaderFactory>;
  ...
  base::WeakPtrFactory<DumbProxyingURLLoaderFactory> weak_factory_;

  DISALLOW_COPY_AND_ASSIGN(DumbProxyingURLLoaderFactory);
};

#endif  // DUMB_BROWSER_NET_DUMB_PROXYING_URL_LOADER_FACTORY_H_
