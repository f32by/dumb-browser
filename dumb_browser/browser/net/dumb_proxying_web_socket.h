...
#ifndef DUMB_BROWSER_NET_DUMB_PROXYING_WEB_SOCKET_H_
#define DUMB_BROWSER_NET_DUMB_PROXYING_WEB_SOCKET_H_
...
#endif  // DUMB_BROWSER_NET_DUMB_PROXYING_WEB_SOCKET_H_
